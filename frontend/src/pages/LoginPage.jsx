    ...
    <div className="min-h-screen flex items-center justify-center bg-notion-bg">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-notion-text">ExpenseThis</h2>
          <p className="mt-2 text-notion-muted">
            Smart expense tracking with Gmail integration
          </p>
        </div>
        ...
        <div className="notion-card">
          ...
          <div className="mt-4 text-sm text-notion-muted text-center">
            <p>
              Sign in with your Google account to enable<br />
              automatic expense tracking from Gmail
            </p>
          </div>
        </div>
